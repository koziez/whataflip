  ...
  <div class="pretty navbar row" id="nav3" style="margin-bottom:0;">
	<div class="row" style="padding: 14px;">
		<div class="ten columns">
			<span class="active">English</span>&nbsp;&nbsp;&nbsp;<a href="../tl/" hreflang="tl">Tagalog</a>
		</div>
		<a href="rss/" style="float:right;">RSS</a>
	</div>
	...
	<div class="container sixteen colgrid" >
		<div class="row shaded" id="content">
			...
			<div class="row">
				<div class="two columns" style="margin:0;width:auto;">
					<div class="medium primary btn"><a href="#"><i class="icon-facebook"></i></a></div>
				</div>
				<div class="two columns" style="margin:0;width:auto;">
					<div class="medium btn" style="background:#82D0D6"><a href="#"><i class="icon-twitter"></i></a></div>
				</div>
				<div class="two columns" style="margin:0;width:auto;">
					<div class="medium btn" style="background:#DA5234"><a href="#"><i class="icon-gplus"></i></a></div>
				</div>
				<div class="two columns" style="margin:0;width:auto;">
					<div class="medium btn" style="background:#0073B2"><a href="#"><i class="icon-linkedin"></i></a></div>
				</div>
			</div>
			  <hr>
			  <h4 class="lead">Weather</h4>
			  <div class="row">
					<div class="sixteen columns centered" style="margin:21px 0 14px 0;text-align:center;">
						<img src="../img/weather-demo.jpg"></p>
					</div>
			  </div>
			  <hr>
			  <h4 class="lead">Verse of the Day</h4>
			  <dl style="margin:21px 0;padding:0 14px;">
				<dd>Commit to the LORD whatever you do, and your plans will succeed.</dd>
				<dt style="float:right;margin-bottom:21px;">— Proverbs 16:3</dt>
			  </dl>
			  <hr>
			  <h4 class="lead">Philippine News</h4>
			  <ul style="margin:21px 0;padding:0 14px;">
				<li><a href="http://newsinfo.inquirer.net/10131/habitat-youngsters-build-homes-for-a-day" target="_blank">Habitat: Youngsters build homes for a day</a></li>
				<li><a href="http://newsinfo.inquirer.net/10129/rizal-at-150-in-visit-to-hk-prison-he-saw-oppression" target="_blank">Rizal at 150: In visit to HK prison, he saw oppression</a></li>
			  </ul>
			  <hr>
			  <h4 class="lead">DFW Churches</h4>
			  <ul style="margin:21px 0;padding:0 14px;">
				<li><p><a href="http://www.biblicalcommunity.com/index.cfm?i=3554" target="_blank">Biblical Community Church</a> <br>
					Dr. Russell Butch  Diwa <br>
					810 W. Lookout Drive <br>
					Richardson, TX 75080 <br>
					Office: (972) 231-6344</p>
				</li>
				<li><p><a href="http://www.mosaicfellowshipchurch.org/" target="_blank">Mosaic Fellowship Church</a><br>
					Pastor Ariel Tolentino <br>
					213 W. Marshall Drive, Suite 413 <br>
					Grand Prairie, TX 75051 <br>
					(214) 682 6052</p>
				</li>
				<li><p><a href="http://www.pcfdallas.org/main//" target="_blank">Praise Christian Fellowship</a> <br>
					Pastor Jofre Perez  <br>
					2825 Valley View Ste. 400 <br> 
					Farmers Branch, Texas 75234 <br>
					(817)946-5337 </p>
				</li>
				<li><p><a href="http://www.mabuhayministries.org/" target="_blank">Mabuhay Ministries</a> <br>
					Pastor Princeton Abaraoha  <br>
					Westminster Presbyterian Church<br>
					8200 Devonshire, Dallas, TX 75209<br>
					(817) 789-4712</p>
				</li>
				<li><p><a href="http://www.nationsworship.com/" target="_blank">Nations Worship Center</a> <br>
					Pastor Herman Martir <br>
					5430 Miller Ave. Fort Worth, Texas 76119<br> 
					817-535-4114<br>
					</p>
				</li>
			  </ul>
			  ...
			  <p style="margin:21px 0;padding:0 14px;">To find out how:<br><br>
			  call us at <span class="info label">1-800-123-4567</span> or<br>
			  email us at <a href="mailto:advertisement@pinoydfw.com" class="info label">advertisement@pinoydfw.com</a></p> 
			</div>
		</div>
	</div>
	
	<footer class="sixteen colgrid">
		<div class="row shaded" style="padding-bottom:43px;padding-top:14px;">
			<ul class="nine columns">
				<li style="display: inline;margin-right:14px;"><a href="terms/">Terms of Use</a></li>
				<li style="display: inline;margin-right:14px;"><a href="privacy/">Privacy Policy</a></li>
				<li style="display: inline;margin-right:14px;"><a href="about/">About PinoyDFW</a></li>
				<li style="display: inline;"><a href="contact/">Contact Us</a></li>
			</ul>
			<div class="seven columns">
				<p style="text-align:right;float:right;">&copy; Pinoy DFW, 2010-2013. All rights reserved.</p>
			</div>
		</div>
	</footer>
